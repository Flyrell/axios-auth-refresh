 ...
 */
export default function createAuthRefreshInterceptor(axios: AxiosStatic, refreshTokenCall: (error: any) => Promise<any>, options?: AxiosAuthRefreshOptions): number;
/**
 ...
 * Creates refresh call if it does not exist or returns the existing one
 */
export declare function createRequestQueueInterceptor(axios: AxiosStatic, cache: AxiosAuthRefreshCache): number;
